...
public class TestController {
    ...
    public Object test1() {
        ...
        params.put("token", "002684ba533f61234d527871f0c8db51b47c0e2a");
        params.put("type", "3");
    ...
    public Object test2(@PathVariable("bookId") String bookId) {

        DSRequest request = new DSRequest();
        request.setUrl("https://www.6tiantian.com");
        request.setPath("/api/teacher/book/info");
        Map<String, Object> params = new HashMap<>();
        params.put("customConfigId", "custom_config_id_2");
        params.put("token", "002684ba533f61234d527871f0c8db51b47c0e2a");
        params.put("bookId", bookId);
        request.setParam(JSONObject.toJSONString(params));
        return testService.test2(request);
    }
